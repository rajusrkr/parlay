    ...
    <div className="px-10 mt-4 space-y-4 max-w-6xl mx-auto">
      ...
      <div className="flex items-center gap-2">
        ...
        <Chip color="secondary" variant="flat" size="lg">
          <span className="capitalize font-semibold">{marketCategory}</span>
        </Chip>
      </div>
      ...
      <div>
        <div className="space-x-3 flex items-center">
          ...
          {<MarketSettings marketData={marketData} />}
        </div>
      </div>
          ...
          <TableBody>
            {outcomesAndPrices.map((otcmsAndPrice) => (
              <TableRow key={otcmsAndPrice.outcome}>
                <TableCell>
                  <span className="capitalize">{otcmsAndPrice.outcome}</span>
                </TableCell>
                <TableCell>
                  <span className="capitalize">{otcmsAndPrice.price}</span>
                </TableCell>
                <TableCell>
                  <span className="capitalize">{otcmsAndPrice.tradedQty}</span>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
        ...
        <Card className="max-w-lg">
          <CardBody className="space-y-4">
            <div>
              ...
              <p className="ml-4 font-semibold text-black/60">
                {marketOverview}
              </p>
            </div>
            <div>
